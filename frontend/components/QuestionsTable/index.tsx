...
import { COLUMNS, COLUMN_CONFIGS, COMPLEXITY_OPTIONS, ColumnKey, MOCK_DATA } from "./config";
...
const QuestionsTable = () => {
  ...
  const filteredItems = React.useMemo(() => {
    ...
    const isAllDifficultiesSelected = complexityFilter == "all" ||
  ...
  React.useCallback((e: React.ChangeEvent<HTMLSelectElement>) => {
